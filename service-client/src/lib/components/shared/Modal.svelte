...
<dialog
	...
	onclose={handleClose}
	class={`${maxWidth} ${height} ${position} bg-base-100 text-base-content fixed z-50 max-h-svh w-11/12 overflow-x-hidden overflow-y-auto rounded-xl shadow-xl border border-base-300`}
>
