...
// Server logger mock removed - not using server logger in client code
...
describe("ConsultationStore", () => {
	...
	describe("data management", () => {
		...
		it("should calculate completion percentage correctly", () => {
			...
			consultationStore.updateSectionData("contact_info", { email: "test@example.com" });
			consultationStore.updateSectionData("business_context", {
				industry: "technology",
	...
	describe("auto-save functionality", () => {
		...
		it("should trigger auto-save when data is updated", async () => {
			...
			expect(mockConsultationApiService.saveDraft).toHaveBeenCalledWith("mock-token", "test-id", {
	...
	describe("form validation", () => {
		...
		it("should validate business_context step requires industry", () => {
			...
			expect(isValid).toBe(false);
			expect(consultationStore.getSectionErrors("business_context")).toContain(
		...
		it("should validate pain_points step requires challenges", () => {
			...
			expect(isValid).toBe(false);
			expect(consultationStore.getSectionErrors("pain_points")).toContain(
				"At least one primary challenge is required",
			);
		});
		...
		it("should validate goals_objectives step requires goals", () => {
			...
			expect(isValid).toBe(false);
			expect(consultationStore.getSectionErrors("goals_objectives")).toContain(
	...
	describe("error handling", () => {
		...
		it("should retry auto-save on failure", async () => {
			...
			mockConsultationApiService.saveDraft = vi
				.fn()
