...
- Files:
  - `apps/service-client/src/lib/api/invoices.remote.ts` (1489 lines)
  - `apps/service-client/src/lib/api/contracts.remote.ts` (1408 lines)
  - `apps/service-client/src/lib/api/proposals.remote.ts` (1322 lines)
  - `apps/service-client/src/lib/api/forms.remote.ts` (1129 lines)
...
**Drizzle Schema Size:**
- Issue: `apps/service-client/src/lib/server/schema.ts` is 1615 lines in a single file with all table definitions mixed together
- Files: `apps/service-client/src/lib/server/schema.ts`
...
- Files:
  - `apps/service-client/src/routes/c/[slug]/+page.server.ts` (lines 43-47)
  - `apps/service-client/src/routes/p/[slug]/+page.server.ts` (line 56)
  - `apps/service-client/src/routes/i/[slug]/+page.server.ts` (line 39)
...
- Files: Throughout `apps/service-client/src`
...
- Files:
  - `apps/service-client/src/routes/c/[slug]/+page.server.ts` (lines 154-155)
  - `apps/service-client/src/lib/api/contracts.remote.ts` (lines 777, 815, 828, 854, 1306, 1346-1347)
...
- Note: Email infrastructure exists (`apps/service-client/src/lib/api/email.remote.ts`) but integration not completed
...
- Files:
  - `apps/service-client/src/routes/c/[slug]/+page.svelte` (lines 216, 281)
  - `apps/service-client/src/routes/p/[slug]/+page.svelte` (lines multiple)
  - `apps/service-client/src/routes/(app)/[agencySlug]/contracts/[contractId]/+page.svelte`
...
- Files:
  - `apps/service-client/src/routes/c/[slug]/+page.server.ts` (unauthenticated load)
  - `apps/service-client/src/routes/i/[slug]/+page.server.ts` (unauthenticated load)
  - `apps/service-client/src/routes/p/[slug]/+page.server.ts` (unauthenticated load)
...
- Files:
  - `apps/service-client/src/lib/api/contracts.remote.ts` (line 380)
  - `apps/service-client/src/lib/api/proposals.remote.ts` (line 282)
  - `apps/service-client/src/lib/api/super-admin.remote.ts` (multiple)
  - `apps/service-client/src/routes/c/[slug]/+page.server.ts` (line 34)
...
- Files: `apps/service-client/src/lib/server/db-helpers.ts`, `apps/service-client/src/lib/server/permissions.ts`
...
- Files: `apps/service-client/src/lib/server/services/claude.service.ts` (line 33)
...
- Files:
  - `apps/service-client/src/lib/api/consultation.remote.test.ts` (761 lines)
  - `apps/service-client/src/lib/tests/*.test.ts` (multiple)
...
- Problem: `apps/service-client/src/lib/server/services/data-pipeline.service.ts` (750 lines) handles merge field resolution
...
- Files: Throughout `apps/service-client/src`, particularly in `claude.service.ts` (lines 264-296)
...
- Files: `apps/service-client/src/lib/api/*.remote.ts`
...
- Files: `apps/service-client/src/lib/stores/agency-config.svelte.ts` (module-level state)
...
- Files: `apps/service-client/src/lib/api/contracts.remote.ts` (generates HTML from JSON template)
...
- Files: `apps/service-client/src/routes/c/[slug]/+page.server.ts` (slug-based access)
...
- Files: `apps/service-client/src/lib/api/*.remote.ts` (uses Valibot); `apps/service-client/package.json` (has both)
...
- Files: `apps/service-client/src/lib/server/services/claude.service.ts`
...
- Files: `svelte.config.js`, `apps/service-client/package.json`
...
- Files: `apps/service-client/package.json`
...
- Files: `apps/service-client/src/lib/server/permissions.ts` (506 lines, no test file)
...
- Files: `apps/service-client/src/lib/api/` (9 remote function files, 1 test file)
...
- Files: `apps/service-client/src/lib/templates/email-templates.ts` (922 lines, no tests)
...
- Files: `apps/service-client/src/lib/api/stripe.remote.ts` (uses Stripe SDK)
