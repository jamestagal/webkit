...
type User struct {
	...
	SubscriptionActive bool                   `protobuf:"varint,11,opt,name=subscription_active,json=subscriptionActive,proto3" json:"subscription_active,omitempty"`
...
const file_user_proto_rawDesc = "" +
	"\n" +
	"\n" +
	"user.proto\x12\x05proto\"\xd6\x02\n" +
	"\x04User\x12\x0e\n" +
	...
	"\x06access\x18\x06 \x01(\x03R\x06access\x12\x10\n" +
	"\x03sub\x18\a \x01(\tR\x03sub\x12\x16\n" +
	"\x06avatar\x18\b \x01(\tR\x06avatar\x12'\n" +
	"\x0fsubscription_id\x18\t \x01(\tR\x0esubscriptionId\x12)\n" +
	"\x10subscription_end\x18\n" +
	" \x01(\tR\x0fsubscriptionEnd\x12/\n" +
	"\x13subscription_active\x18\v \x01(\bR\x12subscriptionActive\x12\x17\n" +
	"\aapi_key\x18\f \x01(\tR\x06apiKeyB\x0eZ\fgofast/protob\x06proto3"
